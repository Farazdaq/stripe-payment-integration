...
Atpay 1.0.1, is an admin dashboard, allows bassness manager and sales team to manage clients, products/packages, subscriptions, invoices, transitions and with useful statistics overview for supporting financial decisions. it also include client mobile access to allow secure payment , payment methods managements , subscriptions tracking and available packages display
