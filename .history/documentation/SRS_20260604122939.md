...
> AtPay 1.0.1, is an admin dashboard & client mobile app, allows bassness manager and sales team to manage clients, products/packages, subscriptions, invoices, transitions and with useful statistics overview for supporting financial decisions. it also include client mobile access to allow secure payment , payment methods managements , subscriptions tracking and available packages display. thus AtPay ingrate with stripe api cloud service. To keep clients flow up of citral actions & important events, AtPay used firebase push notifications and emailing functionalities.
