              ...
              <React.Fragment key={item.id}>
                ...
                <tr className="text-center" style={{ borderColor }}>
                  ...
                  <td className="p-3 border-b flex items-center justify-center gap-3">
                    <button
                      onClick={() => onEdit?.(item)}
                      className="underline text-[#E0E0DD] hover:text-[#E0E0DD]"
                    >
                      Edit
                    </button>
                ...
                {isOpen && (
                  <tr>
                    <td
                      ...
                      style={{ borderColor }}
                    >
                      <div className="grid md:grid-row-2 gap-6 items-start">
                        {/* LEFT SIDE */}
                        <div>
                          <h3 className="font-semibold mb-2">Features</h3>
                          <ul className="list-disc pl-5 text-sm text-[#E0E0DD]">
                          ...
                          <p className="text-sm text-[#E0E0DD]">
                            {item.description}
                          </p>
                        </div>

                        {/* RIGHT SIDE */}
                        <div className="flex flex-row gap-2 ml-80">
                          <ImgViewer
                          ...
                          <FileUploader
                            ...
                            iconColor={theme.colors.borderColor}
                            text="Change"
