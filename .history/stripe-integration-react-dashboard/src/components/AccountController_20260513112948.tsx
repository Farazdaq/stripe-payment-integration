...
// handles auth user name and style
function UserName({
  userName,
  textColor,
}: {
...
// create login button with icon and specified color
...
// create logout button with icon and specified color
...
// orchestrate logout and login based on detected state
// based on isLogIn then it reruns what action button top view
...
// main comp function that groups all and handles actions and views
// based on the meant display map
